document.addEventListener('DOMContentLoaded', function() {
    ...
    /*Загружает данные о товарах с API и инициализирует их отображение*/
    ...
    /*Фильтрует и сортирует товары на основе выбранных критериев*/
    ...
    /*Добавляет товар в корзину и сохраняет его в localStorage*/
